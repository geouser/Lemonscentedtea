		...
		<div class="container">
			...
			<article class="single-case__aticle">
				...
				<div class="single-case-heading">
					...
					<h2 class="single-case__subtitle">Twente helps the Randstad with their space time</h2>	
				</div>
				...
				<div class="gallery-slider">
					<figure class="figure gallery-slider__slide" style="background-image: url('https://unsplash.it/1440/600?image=65')">
						<figcaption class="gallery-slider__slide__text">Visit Twente: brand photography</figcaption>
					</figure>
					<figure class="figure gallery-slider__slide" style="background-image: url('https://unsplash.it/1440/600?image=62')">
						<figcaption class="gallery-slider__slide__text">Visit Twente: brand photography</figcaption>
					</figure>
					<figure class="figure gallery-slider__slide" style="background-image: url('https://unsplash.it/1440/600?image=63')">
						<figcaption class="gallery-slider__slide__text">Visit Twente: brand photography</figcaption>
					</figure>
				</div>
